...
'''
    ...
    --model retinanet_resnet50_fpn --epochs 16 \
    --batch-size 4 --workers 8 --lr-steps 13 15 \
    --world-size 4 --world-size 4 \
    --aspect-ratio-group-factor 3 --lr 0.01 \
    --weights-backbone ResNet50_Weights.IMAGENET1K_V1 \
    2>&1 | tee ../logs/train_exp.txt

    (test)
    torchrun --nproc_per_node=1 train.py --dataset coco --data-path=/media/data/coco \
    --model retinanet_resnet50_fpn \
    --batch-size 4 --workers 8 \
    --test-only --weights-path /home/hslee/INU_RISE/01_PyTorch_RetinaNet/train/custom_recipe2_model_15.pth \
    2>&1 | tee /home/hslee/INU_RISE/01_PyTorch_RetinaNet/logs/custom_recipe2_model_15.txt
'''